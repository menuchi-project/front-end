...
import { PublicMenuViewerComponent } from './main/components/public-menu-viewer/public-menu-viewer.component';
...
const routes: Routes = [
  ...
  { path: 'menu/:menuId', component: PublicMenuViewerComponent },
  {
